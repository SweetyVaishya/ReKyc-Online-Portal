...
namespace KYCApllication_Admin
{
    public partial class Generatereport : System.Web.UI.Page
    {
      ...
      ,[create_date]
      ,[reply_date]
  FROM [kycdetail]  WHERE [Create_at] BETWEEN '" + From + "' AND '" + To + "' AND YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application search by data from " + From + "  to " + To + "";
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE  kd.[Create_at] BETWEEN '" + From + "' AND '" + To + "' AND kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
