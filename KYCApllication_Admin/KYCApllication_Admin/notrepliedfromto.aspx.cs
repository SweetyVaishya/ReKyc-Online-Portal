...
{
    public partial class notrepliedfromto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string notreplied = Convert.ToString(Session["notreplied"]);
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [id]
                      ...
                      ,[create_date]
                      ,[reply_date]
                  FROM [kycdetail] WHERE [status] = ''  AND [Create_at] BETWEEN '" + From + "' AND '" + To + "' AND YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application search by not replied data from '" + From + "'  to '" + To + "'";
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[status] = ''  AND kd.[create_date ] BETWEEN '" + From + "' AND '" + To + "' AND kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
