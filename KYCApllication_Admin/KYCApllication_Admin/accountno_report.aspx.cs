...
{
    public partial class accountno_report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [id]
                  ...
                  ,[create_date]
                  ,[reply_date]
              FROM [kycdetail] WHERE acoount_no='" + acoount_no + "' and YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application serch account no. '" + acoount_no + "'";
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[acoount_no]='" + acoount_no + "' AND kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
