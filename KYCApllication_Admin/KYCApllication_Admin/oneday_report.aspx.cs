...
{
    public partial class oneday_report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string Create_at = Convert.ToString(Session["Create_at"]);
      ...
      ,[status]
      ,[create_date]
  FROM [kycdetail]  where [create_date]= '" + Create_at + "' ", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application Submitted on '"+ Create_at + "'";
