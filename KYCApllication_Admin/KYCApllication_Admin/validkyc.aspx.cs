...
{
    public partial class validkyc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [id]
                  ...
                  ,[create_date]
                  ,[reply_date]
              FROM [kycdetail] where status='approved' AND YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[status]='approved' AND kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
