...
{
    public partial class invalidfromto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string rejected = Convert.ToString(Session["rejected"]);
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [id]
                  ...
                  ,[create_date]
                  ,[reply_date]
              FROM [kycdetail] WHERE [status]='" + rejected + "' AND [reply_date] BETWEEN '" + From + "' AND '" + To + "' AND YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application search by rejected data from '" + From + "'  to '" + To + "'";
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[status]='" + rejected + "' AND kd.[reply_date] BETWEEN '" + From + "' AND '" + To + "' AND  kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
