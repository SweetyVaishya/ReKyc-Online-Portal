...
namespace KYCApllication_Admin
{
 ...
 ,[PancardFileNm]
                              ,[AadharcardFileNm]
              FROM [kycdetail] where YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = " KYC Application recieved all record ";
            ...
            // Clear the paginationPanel before adding new links
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc ";
            ...
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                //   gridView.Columns.Add(new BoundField { HeaderText = "Submitted Date", DataField = "Create_at" });
