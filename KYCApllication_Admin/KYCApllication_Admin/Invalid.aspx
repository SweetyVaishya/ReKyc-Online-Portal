<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Invalid.aspx.cs" Inherits="KYCApllication_Admin.Invalid" %>
     ...
     <div class="row mt-3">
        ...
        <div class="card shadow-lg p-3 mt-3" style="background-color: #fdf69e;">
            ...
            <div class="text-center mt-3">
                <asp:Label ID="lblfromto" runat="server" type="date" Style="font-size: 130%;" Text="Rejected Data"></asp:Label>
                <br />
