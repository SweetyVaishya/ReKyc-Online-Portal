<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Generatereport.aspx.cs" Inherits="KYCApllication_Admin.Generatereport" %>
     ...
     <div class="row mt-3 mb-5">
        ...
        <div class="card shadow-lg p-3 mt-3" style="background-color: #fdf69e;">
            ...
            <div class="text-center mt-3">
                 <asp:Label ID="roshan" runat="server" type="date" Style="font-size: 130%;" Text=""></asp:Label>
