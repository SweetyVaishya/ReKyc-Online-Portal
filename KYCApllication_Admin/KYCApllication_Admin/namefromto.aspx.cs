...
{
    public partial class namefromto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [id]
                  ...
                  ,[create_date]
                  ,[reply_date]
              FROM [kycdetail] WHERE [Name]='" + name + "' AND [Create_at] BETWEEN '" + From + "' AND '" + To + "' AND YearsOfServiceBusinessHA !='' order by Create_at desc", con);
            con.Open();
            ...
            lblfromto.Text = "KYC Application serch  by name '" + name + "' from '"+From+"'  to '"+To+"'";
        ...
        SELECT kd.[id], 
                ...
                aad.[DOB2] AS [DOB2_AadharApi]
                        ...
                        WHERE kd.[Name]='" + name + "' AND kd.[create_date] BETWEEN '" + From + "' AND '" + To + "' AND kd.[YearsOfServiceBusinessHA] != '' order by Create_at desc";
