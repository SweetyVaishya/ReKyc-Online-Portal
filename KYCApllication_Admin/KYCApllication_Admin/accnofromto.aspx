<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="accnofromto.aspx.cs" Inherits="KYCApllication_Admin.accnofromto" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row mt-3">
         ...
         <div class="col-md-1"></div>
             <div class="col-md-10">
        <div class="card shadow-lg p-3 mt-3 px-5" style="background-color: #fdf69e;">
        ...
        <div class=" table-responsive-lg mt-3" style="background-color: #fdf69e;">
            <table id="dtBasicExample" class="table table-striped table-bordered table-sm p-4" cellspacing="0" width="100%">
