<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="acknowledgement.aspx.cs" Inherits="KycApplication.WebForm1" %>
                ...
                <div class="row  mt-2">
                    ...
                    <div class="col-md-11">
                        ...
                        <h5>
                            ...
                            Thank you very much for successfully submitting self declaration for <br />Re-KYC under Acknowledgement ID :&nbsp;<asp:Label ID="Acknowlodge_no" runat="server" Text=""></asp:Label>, <br />which is subject to Approval by the Bank.<br />
                            <br />
                            Thanking you, <br />
